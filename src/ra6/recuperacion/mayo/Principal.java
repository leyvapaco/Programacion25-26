...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        // CANADÁ
        can.addJugador(new Jugador(19, "Alphonso Davies", 25, Jugador.Demarcacion.DEFENSA));
        can.addJugador(new Jugador(1, "Borjan", 38, Jugador.Demarcacion.PORTERO));

        // BRASIL
        bra.addJugador(new Jugador(10, "Vini Jr", 34, Jugador.Demarcacion.DELANTERO));
